...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      require('mini.surround').setup {
        -- Ensure mini.surround doesn't use 'gh' keybinding
        mappings = {
  ...
  -- NOTE: Custom plugins are now in separate files for better organization
  -- The import below automatically loads all plugins from `lua/custom/plugins/*.lua`
  --
  -- Currently includes:
  --   - claude-code.lua : Claude Code AI assistant integration
  --   - oil.lua         : Buffer-based file editor
  --   - neo-tree.lua    : Tree-based file explorer
  --
  -- To add new plugins, create a new .lua file in lua/custom/plugins/ that returns a plugin spec
  { import = 'custom.plugins' },

  -- DEPRECATED: Large plugin configs have been moved to separate files
  -- If you want to add a quick/simple plugin, you can still add it here inline
  -- For complex plugins with lots of config, create a file in lua/custom/plugins/
  --
