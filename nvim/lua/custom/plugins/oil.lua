...
-- A file explorer that lets you edit your filesystem like a text buffer.
-- Rename files by changing text, delete with dd, create by adding lines.
-- Press :w to save all changes at once.
--
-- Keybindings:
--   - (normal mode): Open parent directory in Oil
...
--   Edit text to rename, dd to delete, add lines to create
